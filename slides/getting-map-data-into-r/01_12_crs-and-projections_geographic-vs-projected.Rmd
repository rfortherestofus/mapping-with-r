...
## Geographic CRS<sup>1</sup> vs Projected CRS
...
.footnote[
[1] **C**ordinate **R**eference **S**ystems
]
...
> Not all coordinate reference systems have a **CRS** code... but all coordinate reference systems do have a **proj4string**.
...
### PROJ and proj4strings

PROJ is **the** software for transforming coordinates between different CRS - it's integrated into all GIS software, including `{sf}`.

In R code we specify CRS to PROJ as a `proj4string`.
